...
<div class="admin-header">
    <div class="admin-header-left">
        <a href="/admin/homepage.php" class="btn btn-link">&larr; Retour</a>
        <h1><?= $isEdit ? 'Modifier la section' : 'Nouvelle section' ?></h1>
    </div>
</div>
...
<form method="post" enctype="multipart/form-data" id="sectionForm">
    ...
    <div class="form-grid">
        ...
        <div class="admin-card">
            ...
            <div class="admin-card-body">
                <div class="form-group">
                    ...
                    <select name="type" id="type" class="form-control" required onchange="updateFormFields()">
                ...
                <div class="form-row cta-fields">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cta_url" id="cta_url" class="form-control"
                ...
                <div class="form-group media-field">
                    ...
                    <?php if ($section && $section['media_url']): ?>
                        <div class="current-media">
                            ...
                            <?php endif; ?>
                            <p class="text-muted">Média actuel</p>
                        </div>
                    <?php endif; ?>
                    <input type="file" name="media_file" id="media_file" class="form-control"
                           accept="image/*,video/mp4,video/webm">
                    <small class="text-muted">Formats : JPG, PNG, GIF, WebP, MP4, WebM</small>
                </div>
        ...
        <div class="admin-card items-card" id="itemsCard" style="display: none;">
            <div class="admin-card-header">
                <h2 id="itemsCardTitle">Sélection</h2>
                <span class="badge badge-info" id="itemsCount">0 sélectionné(s)</span>
            </div>
            <div class="admin-card-body">
                <!-- Produits -->
                <div id="productsSelection" style="display: none;">
                    <p class="text-muted mb-3">Sélectionnez les produits à afficher (max 8 recommandé)</p>
                    <div class="items-grid">
                        <?php foreach ($products as $product): ?>
                            <label class="item-checkbox">
                                ...
                                <div class="item-card">
                                    <?php if ($product['image_front_url']): ?>
                ...
                <div id="packsSelection" style="display: none;">
                    <p class="text-muted mb-3">Sélectionnez les packs à afficher (max 6 recommandé)</p>
                    <div class="items-grid">
                ...
                <div id="blogInfo" style="display: none;">
                    <div class="info-box">
                        ...
                        <p>Le slider blog affiche automatiquement les derniers articles publiés. Gérez vos articles dans <a href="/admin/blog.php">Blog</a>.</p>
                    </div>
                </div>
            </div>
        </div>
