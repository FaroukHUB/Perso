<?php
/**
 * PERSONNALY - Upload d'images pour TinyMCE
 * Endpoint AJAX pour l'insertion d'images dans les articles
 */
...
$uploadDir = __DIR__ . '/../public/uploads/blog/content/';
if (!is_dir($uploadDir)) {
...
$filename = 'img_' . date('Ymd') . '_' . uniqid() . '.' . $ext;
$filepath = $uploadDir . $filename;

// Upload
if (move_uploaded_file($file['tmp_name'], $filepath)) {
    $url = '/public/uploads/blog/content/' . $filename;
    echo json_encode([
        'success' => true,
        'url' => $url,
        'location' => $url // TinyMCE attend "location"
    ]);
} else {
