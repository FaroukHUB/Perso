...
<div class="admin-page">
    ...
    <main class="admin-main">
        <div class="page-header">
            <div>
                <h1>Catégories</h1>
                <p class="text-muted">Organiser vos produits par catégories</p>
            </div>
                        ...
                        <tbody id="categoriesList">
                            <?php foreach ($categories as $cat): ?>
                                <tr data-id="<?= $cat['id'] ?>" class="draggable-row">
                                    ...
                                    <td>
                                        <span class="badge badge-mint"><?= $cat['product_count'] ?></span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="/admin/categories.php?action=toggle&id=<?= $cat['id'] ?>&csrf=<?= $csrfToken ?>"
                                            ...
                                            <?php if ($cat['product_count'] == 0): ?>
                                                <a href="/admin/categories.php?action=delete&id=<?= $cat['id'] ?>&csrf=<?= $csrfToken ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveOrder() {
        ...
        fetch('/admin/categories.php', {
            ...
            body: 'action=reorder&csrf_token=<?= $csrfToken ?>&' + order.map((id, i) => `order[${i}]=${id}`).join('&')
        })
        .then(r => r.json())
        .then(data => {
            if (!data.success) {
